...
nnoremap <buffer> <leader>arv :ArduinoVerify<CR>
nnoremap <buffer> <leader>aru :ArduinoUpload<CR>
nnoremap <buffer> <leader>ard :ArduinoUploadAndSerial<CR>
nnoremap <buffer> <leader>arb :ArduinoChooseBoard<CR>
nnoremap <buffer> <leader>arp :ArduinoChooseProgrammer<CR>
